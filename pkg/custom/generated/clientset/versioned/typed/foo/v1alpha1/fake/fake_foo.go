...
import (
	...
	v1alpha1 "github.com/zhaohuabing/k8sControllerTutorial/pkg/custom/apis/foo/v1alpha1"
...
var foosResource = schema.GroupVersionResource{Group: "foo", Version: "v1alpha1", Resource: "foos"}

var foosKind = schema.GroupVersionKind{Group: "foo", Version: "v1alpha1", Kind: "Foo"}
